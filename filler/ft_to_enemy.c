...
static int		ft_to_enemy(t_row i, t_xy psbl_xy, t_map piece)
{
	t_xy	xy;
	int		dist;
	int		min;
...
static int		ft_get_min(t_row i, t_xy *psbl_xy, int *res, t_map piece)
{
	int		j;
	int		x;
	int		dist;
...
static void	ft_get_position(t_row i, t_xy *psbl_xy, t_xy *info, t_map piece)
{
	int min;
