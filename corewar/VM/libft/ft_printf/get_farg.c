...
void		get_uppc3(va_list ap, char c1, t_format *format, t_list **str)
{
	...
	if (c1 == 'h' && c2 == 'D')
		ft_itoa_pf((unsigned short int)va_arg(ap, unsigned int), str, format);
	else if (c1 == 'h' && c2 == 'U')
...
void		get_c3(va_list ap, char c1, t_format *format, t_list **str)
{
	...
	c2 = (format->variable)[2];
	if (c1 == 'h' && (c2 == 'd' || c2 == 'i'))
		ft_itoa_pf((signed char)va_arg(ap, int), str, format);
	else if (c1 == 'h' && c2 == 'u')
		...
		ft_itoa_pf(va_arg(ap, long long), str, format);
	else if (c1 == 'l' && c2 == 'u')
...
void		get_c2(va_list ap, char c1, t_format *f, t_list **str)
{
	...
	c2 = (f->variable)[1];
	if (c1 == 'h' && (c2 == 'd' || c2 == 'i'))
		ft_itoa_pf((short int)va_arg(ap, int), str, f);
...
void		get_c1(va_list ap, char c1, t_format *format, t_list **str)
{
	...
	if (c1 == 'z' && (c2 == 'd' || c2 == 'i' || c2 == 'D'))
		ft_itoa_pf(va_arg(ap, size_t), str, format);
		...
		ft_itoa_pf(va_arg(ap, intmax_t), str, format);
...
void		get_farg(va_list ap, t_format *f, t_list **str, int *len)
{
	...
	else
	{
		...
		if ((f->variable)[0] == 'l' && (c2 == 'd' || c2 == 'i' || c2 == 'D'))
			ft_itoa_pf(va_arg(ap, long int), str, f);
